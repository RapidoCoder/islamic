	...
	<div class="col-md-12">
		...
		<div class="portlet box green-haze">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-globe"></i>Book Categories
				</div>
				<div class="tools">
          ...
          <div class="row">
           <div class="col-md-6">
            <div class="btn-group">
             ...
             <a href="{{ route('admin-add-book-category') }}" style="color:white;"><button id="sample_editable_1_new" class="btn green">Add New <i class="fa fa-plus"></i>
             </button></a>
