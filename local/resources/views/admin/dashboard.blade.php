...
<div class="row">
  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
    <div class="dashboard-stat blue-madison">
      ...
      <a class="more" href="{!! route('admin-video-categories') !!}">
        View Video Categories <i class="m-icon-swapright m-icon-white"></i>
      </a>
    </div>
  </div>
   <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
    <div class="dashboard-stat blue-madison">
      ...
      <a class="more" href="{!! route('admin-videos') !!}">
        View Videos <i class="m-icon-swapright m-icon-white"></i>
      </a>
    </div>
  </div>
</div>
