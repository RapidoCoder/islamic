...
<div class="row">
          ...
          <div class="row">
           <div class="col-md-6">
            <div class="btn-group">
              ...
              <a href="{!! route('alim-add-video')!!}" style="color:white;"><button id="sample_editable_1_new" class="btn green">Add New <i class="fa fa-plus"></i> 
              </button></a>
    ...
    <tbody>
      ...
      <tr>
       ...
       <td>{{ $video->status }}</td>
       <td>
        {{ link_to_route("alim-update-video","" ,array("id"=> $video->id ),array("class"=>"glyphicon glyphicon-pencil","aria-hidden"=>"true","style"=>"padding:0 5px 0 5px;"))}}{{ link_to_route("alim-delete-video","" ,array("id"=> $video->id ),array("class"=>"glyphicon glyphicon-trash","aria-hidden"=>"true", "onClick"=>"return confirm('Are You Sure to delete the record');"))}}
